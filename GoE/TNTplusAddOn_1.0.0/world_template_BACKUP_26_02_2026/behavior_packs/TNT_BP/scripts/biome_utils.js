...
let currentWeather = () => world.getDynamicProperty("goe_vfx_weather");
...
export function handleWeatherChange(event) {
    ...
    world.setDynamicProperty("goe_vfx_weather", currentWeather);
...
export function isRaining() {
    return world.getDynamicProperty("goe_vfx_weather") === WeatherType.Rain;
}

export function isThundering() {
    return world.getDynamicProperty("goe_vfx_weather") === WeatherType.Thunder;
}
...
export function getWeather(player) {
    ...
    return world.getDynamicProperty("goe_vfx_weather");
}
