...
export const ShopItems = {
    ...
    tnts: [
        ...
        },
        {
            id: "party_tnt",
            name: "Party TNT",
            price: { type: "copper_ingot", amount: 6 },
        ...
        },
        {
            id: "chunker_tnt",
            name: "Chunker TNT",
            price: { type: "gold_ingot", amount: 6 },
    ...
    structures: [
        {
            ...
            icon: "textures/goe/tnt/ui/shop/structure/farm"
        },
        {
            id: "goe_tnt:village_testing_area",
            name: "Village",
            price: { type: "iron_ingot", amount: 15 },
            icon: "textures/goe/tnt/ui/shop/structure/village"
        },
        {
            id: "goe_tnt:hotel_testing_area",
            name: "Hotel",
            price: { type: "iron_ingot", amount: 15 },
            icon: "textures/goe/tnt/ui/shop/structure/hotel"
        },
        {
            id: "goe_tnt:cabins_testing_area",
            name: "Cabins",
            price: { type: "iron_ingot", amount: 15 },
            icon: "textures/goe/tnt/ui/shop/structure/cabins"
        },
        {
            id: "goe_tnt:construction_site_testing_area",
            name: "Construction Site",
            price: { type: "iron_ingot", amount: 15 },
            icon: "textures/goe/tnt/ui/shop/structure/construction_site"
        }
    ],
...
export const Achievements = {
    ...
    milestones: [
        ...
        },
        {
            id: "milestone_47",
            name: "TNT Legend",
            info: "Discover all types of §4TNT blocks§f to unlock this achievement.",
            tips: "",
            milestoneNumber: 47,
            icon: "textures/goe/tnt/ui/achievements/milestone_total",
            rewardStructure: "goe_tnt:milestone_47_reward"
        }
    ],
